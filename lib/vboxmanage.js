var _ = require('lodash'),
    util = require('./util'),
    createExecString = util.createExecString,
...
function _vboxmanage() {
    return sh.execSync(createExecString('VBoxManage', _.toArray(arguments)));
}
...
vboxmanage.async = function () {
    ...
    exec(createExecString('VBoxManage', args), function (err, stdout, stderr) {
        callback(err, stdout);
    });
