var APIClient = require('radic/git/apiclient'),
    githubRoutes = require('radic/git/routes/github'),
...
function GithubClient(user, pass){
    ...
    this.curl = require('radic/git/curl')(credentials, 'https://api.github.com');
}
