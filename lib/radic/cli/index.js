var path = require('path'),
    ...
    celeri = require('radic/cli/_celeri'),
    Command = require('radic/cli/commands/command'),
    generator = require('radic/cli/commands/generator'),
    Table = require('radic/cli/table'),
...
cli.generateCommand = function(){
    ...
    var type = args[0];
    if(type == 'config') {
        return generator[type].apply(cli, args.splice(1,1));
    }
};
